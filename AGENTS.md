...
34. Tipografía y Color Unificado en la Pantalla de Carga: Ambas líneas de texto en el overlay de carga (`.loading-overlay p` y `.loading-overlay .loading-sub`) deben tener de manera obligatoria y uniforme un tamaño de fuente de `14px !important` y color negro puro `#000000 !important`. No se permiten tamaños distintos ni colores grises atenudos en el texto de carga.
