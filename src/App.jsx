    ...
    <div className={`app reading-size${readingOptions.font ? " reading-font" : ""}${readingOptions.contrast ? " reading-contrast" : ""}${readingOptions.tint ? " reading-tint" : ""}${readingOptions.focus ? " reading-focus" : ""}`} style={{ "--reading-base-size": `${readingFontSize}px` }}>
      ...
      <footer className="app-footer">
        ...
        <span className="app-footer-credit">
          {lang === "es" ? "Hecho por" : "Made by"}: <a href="https://www.martaconde.com" target="_blank" rel="noopener noreferrer" className="marta-link">Marta Conde</a> · <a href="https://www.linkedin.com/in/martacondedesign" target="_blank" rel="noopener noreferrer" className="social-text-link">LinkedIn</a> · <a href="https://www.youtube.com/@martacondedesign" target="_blank" rel="noopener noreferrer" className="social-text-link">YouTube</a> | {lang === "es" ? "Remix del proyecto de:" : "Remix of a project by:"} <a href="https://agentic-design-system-visualization.vercel.app/" target="_blank" rel="noopener noreferrer" className="cristian-link">Cristian Morales</a>
        </span>
      </footer>
    </div>
  );
